            ...
            <div class="filament-modal-content">
                <div class="flex flex-col gap-4">
                    @foreach($notifications as $notification)
                        <div>
                            <div class="flex flex-col gap-4 rounded-lg @if(!$notification->isRead(auth('web')->user()->id)) bg-zinc-200 dark:bg-zinc-700 @else bg-zinc-50 dark:bg-zinc-900 @endif  px-4 py-4">
                                <div
                                    ...
                                    @if(!$notification->isRead(auth('web')->user()->id))
